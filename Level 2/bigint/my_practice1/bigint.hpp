...
class bigint
{
	...
	public:
		...
		{
			std::string result;
			int carry = 0, i = n1.size() - 1, j = n1.size() - 1;
			while (i >= 0 || j >= 0 || carry)
			{
        ...
        // void remove_leading_zeros() 
        // {
        //     size_t non_zero_pos = num.find_first_not_of('0');
        //     if (non_zero_pos == std::string::npos) {
        //         num = "0";
        //     } else {
        //         num = num.substr(non_zero_pos);
        //     }
        // }
...
//         {
//             return bigint(num + std::string(size, '0'));
//         }

//         bigint& operator<<=(size_t size)
//         {

//             num += std::string(size, '0');
//             return *this;
//         }
